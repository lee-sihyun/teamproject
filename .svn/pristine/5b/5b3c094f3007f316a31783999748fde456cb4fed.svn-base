...
<%
	...
	int subcategory4 = ProductDAO.getDAO().getProductsubcategory(4);
	int subcategory5 = ProductDAO.getDAO().getProductsubcategory(5);
	int subcategory6 = ProductDAO.getDAO().getProductsubcategory(6);
	int subcategory7 = ProductDAO.getDAO().getProductsubcategory(7);
	%>
...
<html lang="ko"><head>
    ...
    <link type="text/css" rel="sheet" href="<%=request.getContextPath() %>/resources/gd_contents.css">
...
<div class="sub_visual"><div style="height:500px;background:url('<%=request.getContextPath() %>/resources/shower.jpg') no-repeat 50% 0;">
<p class="subv_txt01" style="padding-top:190px;">SHOWER</p>
<p class="subv_txt02">향기로움을 가득 담은 샤워를 즐겨보세요!</p>
    ...
    <div class="view">
        ...
        <div class="cg-main">
							...
							<div class="align">
								<div class="choice">
									<div>
										...
										<div class="chosen-container chosen-container-single chosen-container-single-nosearch" style="width: 110px; margin-top: 40px; " title="Price asc,g.regDt desc">
										<select>
    									<option value="price gd-default asc">높은 가격순</option><%--순영순영 --%>
    									<option value="1">낮은 가격순</option><%--순영순영 --%>
		  								</select>
										</div>
									</div> 
								</div>
			...
			<ul class="lower-category"> 
				<li><span class="on"><a href="index.jsp?workgroup=rush&work=shower">전체<!-- 배쓰 --></a><em>(<%=productList1.size() %>)</em></span></li>
				<li><span><a href="index.jsp?workgroup=rush&work=shower&subcategory=4">솝</a> <em>(<%=subcategory4%>)</em> </span></li>
				<li><span><a href="index.jsp?workgroup=rush&work=shower&subcategory=5">샤워 젤 &amp;젤리</a> <em>(<%=subcategory5%>)</em> </span></li>
				<li><span><a href="index.jsp?workgroup=rush&work=shower&subcategory=6">보디 컨디셔너</a> <em>(<%=subcategory6%>)</em> </span></li>
				<li><span><a href="index.jsp?workgroup=rush&work=shower&subcategory=7">샤워 밤</a> <em>(<%=subcategory7%>)</em> </span></li>		
