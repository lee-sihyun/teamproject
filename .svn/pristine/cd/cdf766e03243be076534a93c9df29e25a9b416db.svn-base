...
<%-- => [글저장]을 클릭한 경우 게시글 처리페이지(Review_write_action.jsp)로 이동 --%>    
	...
	<div class="section m2">
		...
		<div class="section-body">
			...
			<div class="join-form mt50">
				<form action="<%=request.getContextPath()%>/board/Review/Review_write_action.jsp" method="post" id="boardForm"  >
									...
									<tr>
										<th colspan="2" id="buttons" style="height: 150px;">
											<div class="ta-l buttons">
												...
												<button type="submit" class="save" id="complete" value="작성완료" >작성 완료</button>
											</div>											
										</th>
									</tr>
								</tbody>
...
$("#title").submit(function() {
    ...
    if($("#cancellation").click(function() {
    	location.href="<%=request.getContextPath()%>/index.jsp?workgroup=board/Review&work=Review_list";
    }));
