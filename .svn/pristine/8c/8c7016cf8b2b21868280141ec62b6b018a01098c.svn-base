...
<%
	...
	int subcategory1 = ProductDAO.getDAO().getProductsubcategory(1);
	int subcategory2 = ProductDAO.getDAO().getProductsubcategory(2);
	int subcategory3 = ProductDAO.getDAO().getProductsubcategory(3);
	%>
...
<div class="sub_visual"><div style="height:500px;background:url('<%=request.getContextPath() %>/resources/bathbanner.jpg') no-repeat 50% 0;">
    ...
    <div class="view">
        ...
        <div class="cg-main">
							...
							<div class="align">
								...
								<div class="choice">
									<div>
										...
										<select>
    									<option value="0">높은 가격순</option><%--순영순영 --%>
			...
			<ul class="lower-category"> 
				<li><span class="on"><a href="index.jsp?workgroup=rush&work=bath">전체<!-- 배쓰 --></a><em>(<%=productList1.size() %>)</em></span></li>
				<li><span><a href="index.jsp?workgroup=rush&work=bath&subcategory=1">배쓰 밤</a> <em>(<%=subcategory1%>)</em> </span></li>
				<li><span><a href="index.jsp?workgroup=rush&work=bath&subcategory=2">버블 바</a> <em>(<%=subcategory2%>)</em> </span></li>
				<li><span><a href="index.jsp?workgroup=rush&work=bath&subcategory=3">배쓰 오일</a> <em>(<%=subcategory3%>)</em> </span></li>
