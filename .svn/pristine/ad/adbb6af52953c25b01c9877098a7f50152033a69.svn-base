		        ...
		        <table id="item">
		            ...
		            <tr>
		                ...
		                <td class="oStatus">
		                    ...
		                    <br>
		                    <a class="requestRefund" href="<%=request.getContextPath()%>/lushuser/refund_action.jsp?orderNo=<%=order.getOrderNo()%>">환불요청</a>
		                </td>
		                <td class="dStatus">
		                	<a class="status2">
		                    ...
		                    <br>
		                    <a class="requestExchange" href="<%=request.getContextPath()%>/lushuser/exchange_action.jsp?orderNo=<%=order.getOrderNo()%>">교환요청</a>
		                </td>
		            </tr>
		            <% } %>
		        </table>
...
$(".requestRefund").css("border","1px solid black");
$(".requestExchange").css("border","1px solid black");

/* if($(".status1").val()=="주문완료") {
	$(".requestRefund").css("display","inline-block");
} else {
	$(".requestRefund").css("display","none");
}

if($(".status2").val()=="배송완료") {
	$(".requestExchange").css("display","inline-block");
} else {
	$(".requestRefund").css("display","none");
}	 */
</script>
