...
<%
	if (request.getParameter("num") == null) {
		...
		out.println("loaction.href='" + request.getContextPath()
				+ "/admin/index.jsp?workgroup=board&work=board_list';");
		out.println("</script>");
		return;
	}
...
<div id="content">
	<div class="section">
		<div class="mToggleBar"
			style="width: 1238.989583px; height: 41.979166px; border-bottom-width: 0px; border-right-width: 0px;">
			<h2>공지수정</h2>
		</div>
		<form
			action="<%=request.getContextPath()%>/admin/board/board_modify_action.jsp"
