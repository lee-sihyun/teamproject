 ...
 */
 	//System.out.println("제발 : "+request.getParameter("num"));
	//전달값을 반환받아 저장
	...
	<div class="section m2">
		...
		<div class="section-body">
			...
			<div class="join-form mt50">
					<form method="post" action="<%=request.getContextPath()%>/board/QnA/QnA_modify_action.jsp";>
								...
								<tbody>
									<tr>
										...
										<td>
											<div class="txt-field hs">
												<input type="text" name="title" class="title" value="<%=QnA.getTitle()%>" style = "border: 0px">
											</div>
										</td>
									</tr>
									<tr>
									...
									<tr>
										...
										<td style="width: 300px;">
											...
											<div id="forsizing">
											<textarea 
												 rows="7" cols="100" name="content" id="board_content" <%=QnA.getContent() %>><%=QnA.getContent()%></textarea>
											</div>
										</td>
									</tr>
									<tr>
										<th colspan="2" id="buttons">
											<div class="buttons">
												<a href="<%=request.getContextPath()%>/index.jsp?workgroup=board/QnA&work=QnA_list" class="icon">취소</a>
												<button type="submit" class="save" id="completeModification2" value="작성완료">수정 완료</button>
											</div>											
										</th>
									</tr>
								</tbody>
...
<%-- 
	if($("#completeModification2").submit(function() {	
		location.href="<%=request.getContextPath()%>/index.jsp?workgroup=board/QnA&work=QnA_modify_action";
		--modify 에서 action으로 넘어가질않음 수정!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
	}));	
