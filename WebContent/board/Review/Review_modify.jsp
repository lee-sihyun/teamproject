...
<%
	...
	ReviewDTO QnA=ReviewDAO.getDAO().getReview(num);
		
	//비정상적인 요청에 대한 응답 처리
	// => 로그인 상태가 아니거나 로그인 사용자가 작성자 또는 관리자가 아닌 경우	
	if(loginUser1==null || !loginUser1.getId().equals(loginUser.getId()) && loginUser1.getStatus()!=9) {
		out.println("<script>");
...
<div id="main">
	...
	<div class="section m2">
		<div class="section-header">
			<h2 class="h2">리뷰 수정</h2>
		</div>
		<div class="section-body">
			<p>LUSH 제품을 구입해주셔서 감사합니다. 더욱 아름다운 향기를 제공하겠습니다.</p>
			<div class="join-form mt50">
				<form action="<%=request.getContextPath()%>/board/Review/Review_write_action.jsp" method="post" id="boardForm"  enctype="multipart/form-data">
						...
						<div class="table1 board-write">
							<table>
								...
								<tbody>
									...
									<tr>
										<th class="ta-1">첨부파일</th>
											<td id="uploadBox">
												<div class="file-upload" style="margin-top:5px">
                                      				  <label for="attach1">
                                      				  		<input type="text" class="text" title="파일 첨부하기" readonly="readonly">
                                      				  </label>
                                       			 <div class="upload-btn">
                                            		<button type="button" class="uploadfile" title="찾아보기"><em>찾아보기</em></button>
                                           			<input type="file" name="upfiles[]" id="attach1" class="file" title="찾아보기">
                                           			<button type="button" class="addupload" id="addUploadBtn" style="position:relative"><em>+ 추가</em></button>
                                     		  	 </div>
                                   				 </div>
											</td>
									</tr>
									<tr>
										...
										<td style="width: 300px;">
											<div  id="board_notice">
												<span class="form-element"> 해당글은 공개글입니다. </span>
											</div>
											<div>
									...
									<tr>
										<th colspan="2" id="buttons" style="height: 150px;">
											<div class="ta-l buttons">
												...
												<button type="submit" class="save" id="completeModification" value="수정완료" >수정 완료</button>
											</div>											
										</th>
									</tr>
								</tbody>
...
$("#title").submit(function() {
    ...
    if($("#completeModification").click(function() {
    	location.href="<%=request.getContextPath()%>/index.jsp?workgroup=board/QnA&work=QnA_write_action";
    }));
