		...
		<div class="section" id="QA_list2">
			...
			<div class="mBoardtypeListgScrollgCell">
				...
				<table class="eChkColor">
					...
					<tr>
						...
						<td class="type"><input type="checkbox" name="allCheck"
							id="allCheck"></td>
					...
					<tr>
						...
						<td><a
							href="<%=request.getContextPath()%>/admin/index.jsp?workgroup=product&work=product_detail&num=<%=product.getNum()%>&pageNum=<%=pageNum%>&search=<%=search%>&keyword=
			...
			<div class="mCtrltypeFooter">
				<div class="gLeft">
					...
					<button type="submit" class="btnNormaldelete" name="stockBtn"
						id="stockBtn">재고추가</button>
...
$("#removeBtn").click(function() {
 ...
 $("#productform").attr("action", "<%=request.getContextPath()%>/admin/product/product_stock_action.jsp");
							$("#productform").submit();
						}
					});
</script>
